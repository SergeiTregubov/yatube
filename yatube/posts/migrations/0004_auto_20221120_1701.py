# Generated by Django 2.2.19 on 2022-11-20 14:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='group',
            name='slug',
            field=models.SlugField(max_length=200, unique=True, verbose_name='Ссылки'),
        ),
        migrations.AlterField(
            model_name='post',
            name='author',
        ...
        migrations.AlterField(
            model_name='post',
            name='text',
            field=models.TextField(help_text='Напишите свой пост здесь', max_length=400, verbose_name='Текст'),
        ),
    ]
